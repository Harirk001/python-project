...
def connect_database():
    def connect():
        ...
        try:
            ...
            mycursor.execute(query)
            query = 'create table student(id int not null primary key,name varchar(30),phone varchar(10),email varchar(30),address varchar(100),gender varchar(20),dob varchar(20),date varchar(50),time varchar(50))'
            mycursor.execute(query)
        except:
            query = 'use studentmanagementsystem'
            mycursor.execute(query)
    ...
    connectWindow.geometry('470x250+930+330')
...
connectButton.place(x=1200,y=10)

leftFrame=Frame(root)
leftFrame.place(x=50,y=100,width=400,height=650)
...
rightFrame.place(x=450,y=100,width=1065,height=675)
...
style=ttk.Style()
style.configure('Treeview',rowheight=30,font=('airal',12,'bold'),background='white',fieldbackground='white')
